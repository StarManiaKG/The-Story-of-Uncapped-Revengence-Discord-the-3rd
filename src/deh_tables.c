...
const char *const MENUTYPES_LIST[] = {
	...
	"OP_TSOURDT3RD",
	"OP_TSOURDT3RD_README",
	"OP_TSOURDT3RD_EVENTS",
	"OP_TSOURDT3RD_GAME",
	"OP_TSOURDT3RD_CONTROLS",
	"OP_TSOURDT3RD_VIDEO", "OP_TSOURDT3RD_VIDEO_LIGHTING",
	"OP_TSOURDT3RD_AUDIO", "OP_TSOURDT3RD_AUDIO_EXMUSIC",
	"OP_TSOURDT3RD_PLAYER",
	"OP_TSOURDT3RD_SAVEDATA",
	"OP_TSOURDT3RD_SERVER",
	"OP_TSOURDT3RD_EXTRAS", "OP_TSOURDT3RD_EXTRAS_JUKEBOX", "OP_TSOURDT3RD_EXTRAS_SNAKE",
	"OP_TSOURDT3RD_DEBUGGING",
};
...
struct int_const_s const INT_CONST[] = {
	...
	{"MU_FLAC", MU_FLAC},
	{"MU_OPUS", MU_OPUS},
	{"MU_WAVPACK", MU_WAVPACK},
	{"MU_GME", MU_GME},
	{"MU_MOD_EX", MU_MOD_EX},
	{"MU_MID_EX", MU_MID_EX},
	{"MU_UNKNOWN", MU_UNKNOWN},
