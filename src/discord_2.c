...
discord::Core* core{};
discord::Core::Create(1013126566236135516, DiscordCreateFlags_NoRequireDiscord, &core);

// obtain and require discord
...
srb2gsdk_t *discordRequestList = NULL;

static char self_ip[IP_SIZE+1];

// initalize discord vars
...
{
    struct srb2gsdk_s* app = (struct srb2gsdk_s*)data;
...
void DRPC_UpdatePresence(int argc, char** argv)
{
    discord.RunCallbacks();
    
    struct srb2gsdk_s app;
    ...
    params.client_id = 1013126566236135516;
