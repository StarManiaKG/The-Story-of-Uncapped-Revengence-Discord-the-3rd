...
static  void DrawMD2Ex(INT32 *gl_cmd_buffer, md2_frame_t *frame, float duration, float tics, md2_frame_t *nextframe, FTransform *pos, float scale, UINT8 flipped, UINT8 *color)
{
